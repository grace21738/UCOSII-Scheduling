...
#endif
    //2_Modified
    INT8U           compTime;           /* Lab 1 add to store the residual clock ticks of a task*/
	INT8U           period;             /* Lab 1 task period*/
	INT8U           ddl;             /* Lab 2 task deadline*/
	INT8U           fullComp;             /* Lab 2 task period*/
